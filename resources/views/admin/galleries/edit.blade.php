...
<section class="px-6 pb-20">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="admin-page-header mb-8">
            <p class="text-emerald-400 font-semibold mb-2">Edit Galeri</p>
            <h1 class="text-4xl font-extrabold">Edit Foto Kegiatan</h1>
            <p class="text-slate-400 mt-2">
                Perbarui dokumentasi kegiatan organisasi.
            </p>
        </div>
        ...
        <div class="admin-card bg-white/10 border border-white/10 rounded-3xl p-8">
            <form action="{{ route('admin.galleries.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label class="block mb-3 text-slate-300">Foto Saat Ini</label>
                ...
                <div>
                    ...
                    <input type="date" name="activity_date" value="{{ old('activity_date', $gallery->activity_date) }}"
                        class="w-full bg-slate-900 border border-white/10 rounded-2xl px-5 py-4 text-white focus:border-emerald-400 focus:ring-0">
                ...
                <div>
                    ...
                    <textarea name="description" rows="6"
                        class="w-full bg-slate-900 border border-white/10 rounded-2xl px-5 py-4 text-white focus:border-emerald-400 focus:ring-0">{{ old('description', $gallery->description) }}</textarea>
