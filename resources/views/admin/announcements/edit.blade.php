...
<section class="px-6 pb-20">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="admin-page-header mb-8">
            <p class="text-emerald-400 font-semibold mb-2">Edit Pengumuman</p>
            <h1 class="text-4xl font-extrabold">Perbarui Pengumuman</h1>
            <p class="text-slate-400 mt-2">
                Edit informasi pengumuman organisasi.
            </p>
        </div>
